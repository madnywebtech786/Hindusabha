        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          >
            ...
            <span className="font-body text-xs font-semibold uppercase tracking-[0.24em] text-secondary">
              Sant Mahasabha &middot; Society of Alberta
            </span>
          </motion.div>
          ...
          >
            A home for <span className="text-gradient italic">dharma</span> in
          ...
          >
            The Sant Mahasabha Society of Alberta carries forward the
            spiritual guidance of Swami Chakrapani Ji Maharaj, serving
            Calgary&rsquo;s Hindu community through worship, culture, and
            seva.
          </motion.p>
          ...
          >
            <Button href="/about">Discover Our Mission</Button>
          ...
          <motion.a
            ...
            className="group mt-8 inline-flex max-w-md items-center gap-3 rounded-2xl border border-primary/15 bg-white/60 px-4 py-3 text-left backdrop-blur-sm transition-colors hover:border-primary/30 hover:bg-white"
          >
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary/10 text-secondary">
              <Newspaper className="h-4 w-4" strokeWidth={1.75} />
            </span>
            <span className="flex flex-col">
              <span className="font-body text-[11px] font-semibold uppercase tracking-[0.18em] text-secondary">
                Featured in {PRESS_FEATURE.publication}
              </span>
              <span className="font-body text-[13px] leading-snug text-ink-muted transition-colors group-hover:text-ink">
                Swami Chakrapani Ji Maharaj on world unity in London
              </span>
            </span>
          </motion.a>
          ...
          <motion.p
            ...
            className="mt-8 font-devanagari text-lg text-ink-muted/80"
          >
